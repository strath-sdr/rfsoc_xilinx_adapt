...
__support__ = "https://github.com/strath-sdr/rfsoc_xilinx_adapt"

import ipywidgets as ipw
from pynq import DefaultHierarchy
import xrfdc
from rfsoc_sam.constants import *
from rfsoc_sam.channels import *
...
class Receiver(DefaultHierarchy):
    ...
    def _initialise_adc_tile(self, tile):
        tile.DynamicPLLConfig(1, 360, 3840)
