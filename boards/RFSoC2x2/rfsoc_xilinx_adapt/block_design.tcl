...
User_Company:SysGen:ofdm_rx_hw:1.0\
xilinx.com:ip:ofdm_rx:0.3\
xilinx.com:ip:SpectrumAnalyser:1.1\
User_Company:SysGen:ofdm_tx_hw:1.0\
xilinx.com:ip:ofdm_tx:0.3\
...
proc create_hier_cell_DataInspector_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_DataInspector_1() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_channel_10 { parentCell nameHier } {
  ...
  set ofdm_interpolator [ create_bd_cell -type ip -vlnv User_Company:SysGen:ofdm_tx_hw:1.0 ofdm_interpolator ]

  # Create instance: ofdm_transmitter, and set properties
  set ofdm_transmitter [ create_bd_cell -type ip -vlnv xilinx.com:ip:ofdm_tx:0.3 ofdm_transmitter ]

  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins ofdm_transmitter/AXI4_Lite]
  connect_bd_intf_net -intf_net ofdm_tx_hw_m_axis [get_bd_intf_pins m_axis] [get_bd_intf_pins ofdm_interpolator/m_axis]

  # Create port connections
  connect_bd_net -net ofdm_tx_data [get_bd_pins ofdm_interpolator/data] [get_bd_pins ofdm_transmitter/data]
  connect_bd_net -net ofdm_tx_valid [get_bd_pins ofdm_interpolator/valid] [get_bd_pins ofdm_transmitter/valid]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins ofdm_interpolator/clk] [get_bd_pins ofdm_transmitter/AXI4_Lite_ACLK] [get_bd_pins ofdm_transmitter/IPCORE_CLK]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins ofdm_transmitter/AXI4_Lite_ARESETN] [get_bd_pins ofdm_transmitter/IPCORE_RESETN]
...
proc create_hier_cell_channel_20 { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_OFDM
  ...
  create_hier_cell_DataInspector_1 $hier_obj DataInspector
  ...
  set ofdm_decimator [ create_bd_cell -type ip -vlnv User_Company:SysGen:ofdm_rx_hw:1.0 ofdm_decimator ]

  # Create instance: ofdm_receiver, and set properties
  set ofdm_receiver [ create_bd_cell -type ip -vlnv xilinx.com:ip:ofdm_rx:0.3 ofdm_receiver ]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXI_OFDM] [get_bd_intf_pins DataInspector/M_AXI]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins DataInspector/S_AXI] [get_bd_intf_pins axi_interconnect/M03_AXI]
  connect_bd_intf_net -intf_net SpectrumAnalyser_AXI4_Master [get_bd_intf_pins M_AXI] [get_bd_intf_pins spectrum_analyser/AXI4_Master]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M02_AXI [get_bd_intf_pins axi_interconnect/M02_AXI] [get_bd_intf_pins ofdm_receiver/AXI4_Lite]
  connect_bd_intf_net -intf_net axis_broadcaster_imag_M00_AXIS [get_bd_intf_pins axis_broadcaster_imag/M00_AXIS] [get_bd_intf_pins ofdm_decimator/s_axis_im]
  connect_bd_intf_net -intf_net axis_broadcaster_imag_M01_AXIS [get_bd_intf_pins axis_broadcaster_imag/M01_AXIS] [get_bd_intf_pins spectrum_analyser/AXI4_Stream_Imag_Slave]
  connect_bd_intf_net -intf_net axis_broadcaster_real_M00_AXIS [get_bd_intf_pins axis_broadcaster_real/M00_AXIS] [get_bd_intf_pins ofdm_decimator/s_axis_re]
  connect_bd_intf_net -intf_net axis_broadcaster_real_M01_AXIS [get_bd_intf_pins axis_broadcaster_real/M01_AXIS] [get_bd_intf_pins spectrum_analyser/AXI4_Stream_Real_Slave]
  connect_bd_intf_net -intf_net ofdm_rx_0_AXI4_Stream_Master [get_bd_intf_pins DataInspector/S_AXIS] [get_bd_intf_pins ofdm_receiver/AXI4_Stream_Master]
  ...
  connect_bd_intf_net -intf_net xsg_bwselector_0_m_axis_im [get_bd_intf_pins axis_broadcaster_imag/S_AXIS] [get_bd_intf_pins decimator/m_axis_im]
  connect_bd_intf_net -intf_net xsg_bwselector_0_m_axis_re [get_bd_intf_pins axis_broadcaster_real/S_AXIS] [get_bd_intf_pins decimator/m_axis_re]

  # Create port connections
  connect_bd_net -net DataInspector_irq [get_bd_pins irq] [get_bd_pins DataInspector/irq]
  connect_bd_net -net m_axi_aclk_1 [get_bd_pins s_axis_aclk] [get_bd_pins DataInspector/aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins axis_broadcaster_imag/aclk] [get_bd_pins axis_broadcaster_real/aclk] [get_bd_pins decimator/clk] [get_bd_pins ofdm_decimator/clk] [get_bd_pins ofdm_receiver/AXI4_Lite_ACLK] [get_bd_pins ofdm_receiver/IPCORE_CLK] [get_bd_pins spectrum_analyser/AXI4_Lite_ACLK] [get_bd_pins spectrum_analyser/IPCORE_CLK]
  connect_bd_net -net m_axi_aresetn_1 [get_bd_pins s_axis_aresetn] [get_bd_pins DataInspector/aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins axis_broadcaster_imag/aresetn] [get_bd_pins axis_broadcaster_real/aresetn] [get_bd_pins decimator/xsg_bwselector_aresetn] [get_bd_pins ofdm_receiver/AXI4_Lite_ARESETN] [get_bd_pins ofdm_receiver/IPCORE_RESETN] [get_bd_pins spectrum_analyser/AXI4_Lite_ARESETN] [get_bd_pins spectrum_analyser/IPCORE_RESETN]
  connect_bd_net -net ofdm_rx_hw_data [get_bd_pins ofdm_decimator/data] [get_bd_pins ofdm_receiver/data]
  connect_bd_net -net ofdm_rx_hw_valid [get_bd_pins ofdm_decimator/valid] [get_bd_pins ofdm_receiver/valid]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins ofdm_receiver/AXI4_Stream_Master_TREADY] [get_bd_pins xlconstant_0/dout]
...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins s_axi_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins channel_10/S_AXI] [get_bd_intf_pins s_axi_interconnect/M01_AXI]
  connect_bd_intf_net -intf_net channel_10_m_axis [get_bd_intf_pins m10_axis] [get_bd_intf_pins channel_10/m_axis]
  connect_bd_intf_net -intf_net s_axi_interconnect_M00_AXI [get_bd_intf_pins channel_00/S_AXI] [get_bd_intf_pins s_axi_interconnect/M00_AXI]

  # Create port connections
  connect_bd_net -net M00_ACLK_1 [get_bd_pins m00_axis_aclk] [get_bd_pins channel_00/s_axi_aclk] [get_bd_pins s_axi_interconnect/M00_ACLK]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins m00_axis_aresetn] [get_bd_pins channel_00/s_axi_aresetn] [get_bd_pins s_axi_interconnect/M00_ARESETN]
  connect_bd_net -net S00_ACLK_1 [get_bd_pins s_axi_aclk] [get_bd_pins s_axi_interconnect/ACLK] [get_bd_pins s_axi_interconnect/S00_ACLK]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins s_axi_aresetn] [get_bd_pins s_axi_interconnect/ARESETN] [get_bd_pins s_axi_interconnect/S00_ARESETN]
  connect_bd_net -net m10_axis_aclk_1 [get_bd_pins m10_axis_aclk] [get_bd_pins channel_10/s_axi_aclk] [get_bd_pins s_axi_interconnect/M01_ACLK]
  connect_bd_net -net m10_axis_aresetn_1 [get_bd_pins m10_axis_aresetn] [get_bd_pins channel_10/s_axi_aresetn] [get_bd_pins s_axi_interconnect/M01_ARESETN]
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M00_AXI_OFDM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M10_AXI

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M10_AXI_OFDM
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M00_AXI_OFDM] [get_bd_intf_pins channel_00/M_AXI_OFDM]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins s_axi_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins channel_20/S_AXI] [get_bd_intf_pins s_axi_interconnect/M01_AXI]
  connect_bd_intf_net -intf_net S_AXI_3 [get_bd_intf_pins channel_00/S_AXI] [get_bd_intf_pins s_axi_interconnect/M00_AXI]
  connect_bd_intf_net -intf_net channel_00_M_AXI [get_bd_intf_pins M00_AXI] [get_bd_intf_pins channel_00/M_AXI]
  connect_bd_intf_net -intf_net channel_20_M_AXI [get_bd_intf_pins M10_AXI] [get_bd_intf_pins channel_20/M_AXI]
  connect_bd_intf_net -intf_net channel_20_M_AXI_OFDM [get_bd_intf_pins M10_AXI_OFDM] [get_bd_intf_pins channel_20/M_AXI_OFDM]
  ...
  # Create port connections
  connect_bd_net -net channel_00_irq [get_bd_pins channel_00/irq] [get_bd_pins irq_concat/In0]
  connect_bd_net -net channel_20_irq [get_bd_pins channel_20/irq] [get_bd_pins irq_concat/In1]
  connect_bd_net -net s00_axis_aclk_1 [get_bd_pins s00_axis_aclk] [get_bd_pins channel_00/s_axis_aclk] [get_bd_pins s_axi_interconnect/M00_ACLK]
  connect_bd_net -net s00_axis_aresetn_1 [get_bd_pins s00_axis_aresetn] [get_bd_pins channel_00/s_axis_aresetn] [get_bd_pins s_axi_interconnect/M00_ARESETN]
  connect_bd_net -net s20_axis_aclk_1 [get_bd_pins s20_axis_aclk] [get_bd_pins channel_20/s_axis_aclk] [get_bd_pins s_axi_interconnect/M01_ACLK]
  connect_bd_net -net s20_axis_aresetn_1 [get_bd_pins s20_axis_aresetn] [get_bd_pins channel_20/s_axis_aresetn] [get_bd_pins s_axi_interconnect/M01_ARESETN]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins s_axi_interconnect/ACLK] [get_bd_pins s_axi_interconnect/S00_ACLK]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins s_axi_interconnect/ARESETN] [get_bd_pins s_axi_interconnect/S00_ARESETN]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins irq] [get_bd_pins irq_concat/dout]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC0_Refclk_Freq {360.000} \
   CONFIG.ADC0_Sampling_Rate {3.840} \
   CONFIG.ADC2_Enable {1} \
   CONFIG.ADC2_Fabric_Freq {240.000} \
   CONFIG.ADC2_Outclk_Freq {240.000} \
   CONFIG.ADC2_PLL_Enable {true} \
   CONFIG.ADC2_Refclk_Freq {360.000} \
   ...
   CONFIG.DAC0_Fabric_Freq {240.000} \
   CONFIG.DAC0_Outclk_Freq {240.000} \
   CONFIG.DAC0_PLL_Enable {true} \
   CONFIG.DAC0_Refclk_Freq {360.000} \
   CONFIG.DAC0_Sampling_Rate {3.840} \
   CONFIG.DAC1_Enable {1} \
   CONFIG.DAC1_Fabric_Freq {240.000} \
   CONFIG.DAC1_Outclk_Freq {240.000} \
   CONFIG.DAC1_PLL_Enable {true} \
   CONFIG.DAC1_Refclk_Freq {360.000} \
   CONFIG.DAC1_Sampling_Rate {3.840} \
  ...
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins adc2_clk] [get_bd_intf_pins rfdc/adc2_clk]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins vin2_01] [get_bd_intf_pins rfdc/vin2_01]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins dac1_clk] [get_bd_intf_pins rfdc/dac1_clk]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins vout10] [get_bd_intf_pins rfdc/vout10]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins m_axi_interconnect/S00_AXI] [get_bd_intf_pins receiver/M00_AXI]
  connect_bd_intf_net -intf_net S02_AXI_1 [get_bd_intf_pins m_axi_interconnect/S02_AXI] [get_bd_intf_pins receiver/M10_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_ps1_M00_AXI [get_bd_intf_pins M_AXI] [get_bd_intf_pins m_axi_interconnect/M00_AXI]
  ...
  connect_bd_intf_net -intf_net receiver_M10_AXI_OFDM [get_bd_intf_pins m_axi_interconnect/S03_AXI] [get_bd_intf_pins receiver/M10_AXI_OFDM]
  connect_bd_intf_net -intf_net receiver_M_AXI_OFDM [get_bd_intf_pins m_axi_interconnect/S01_AXI] [get_bd_intf_pins receiver/M00_AXI_OFDM]
  connect_bd_intf_net -intf_net rfdc_m21_axis [get_bd_intf_pins receiver/s20_axis_im] [get_bd_intf_pins rfdc/m21_axis]
  ...
  connect_bd_intf_net -intf_net s20_axis_re_1 [get_bd_intf_pins receiver/s20_axis_re] [get_bd_intf_pins rfdc/m20_axis]
  ...
  connect_bd_intf_net -intf_net transmitter_m10_axis [get_bd_intf_pins rfdc/s10_axis] [get_bd_intf_pins transmitter/m10_axis]
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins m_axi_aclk] [get_bd_pins m_axi_interconnect/ACLK] [get_bd_pins m_axi_interconnect/M00_ACLK]
  connect_bd_net -net ARESETN_1 [get_bd_pins m_axi_aresetn] [get_bd_pins m_axi_interconnect/ARESETN] [get_bd_pins m_axi_interconnect/M00_ARESETN]
  connect_bd_net -net proc_sys_reset_adc2_peripheral_aresetn [get_bd_pins m_axi_interconnect/S02_ARESETN] [get_bd_pins m_axi_interconnect/S03_ARESETN] [get_bd_pins proc_sys_reset_adc2/peripheral_aresetn] [get_bd_pins receiver/s20_axis_aresetn] [get_bd_pins rfdc/m2_axis_aresetn]
  connect_bd_net -net proc_sys_reset_adc3_peripheral_aresetn [get_bd_pins m_axi_interconnect/S00_ARESETN] [get_bd_pins m_axi_interconnect/S01_ARESETN] [get_bd_pins proc_sys_reset_adc0/peripheral_aresetn] [get_bd_pins receiver/s00_axis_aresetn] [get_bd_pins rfdc/m0_axis_aresetn]
  ...
  connect_bd_net -net receiver_irq_1 [get_bd_pins irq] [get_bd_pins receiver/irq]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins m_axi_interconnect/S00_ACLK] [get_bd_pins m_axi_interconnect/S01_ACLK] [get_bd_pins proc_sys_reset_adc0/slowest_sync_clk] [get_bd_pins receiver/s00_axis_aclk] [get_bd_pins rfdc/clk_adc0] [get_bd_pins rfdc/m0_axis_aclk]
  connect_bd_net -net rfdc_clk_adc2 [get_bd_pins m_axi_interconnect/S02_ACLK] [get_bd_pins m_axi_interconnect/S03_ACLK] [get_bd_pins proc_sys_reset_adc2/slowest_sync_clk] [get_bd_pins receiver/s20_axis_aclk] [get_bd_pins rfdc/clk_adc2] [get_bd_pins rfdc/m2_axis_aclk]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: clk_wiz_240M, and set properties
  set clk_wiz_240M [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_240M ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {50.0} \
   CONFIG.CLKOUT1_JITTER {89.608} \
  ...
  # Create instance: rst_ps8_240M, and set properties
  set rst_ps8_240M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_240M ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins s_axi_interconnect/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e/M_AXI_HPM0_LPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins radio/S_AXI] [get_bd_intf_pins s_axi_interconnect/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_intc/s_axi] [get_bd_intf_pins s_axi_interconnect/M01_AXI]
  ...
  connect_bd_intf_net -intf_net diff_clock_rtl_0_1 [get_bd_intf_ports sys_clk] [get_bd_intf_pins clk_wiz_240M/CLK_IN1_D]
  connect_bd_intf_net -intf_net radio_vout00 [get_bd_intf_ports vout00] [get_bd_intf_pins radio/vout00]
  connect_bd_intf_net -intf_net radio_vout10 [get_bd_intf_ports vout10] [get_bd_intf_pins radio/vout10]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_240M/locked] [get_bd_pins rst_ps8_240M/dcm_locked]
  connect_bd_net -net clk_wiz_260M_clk_out1 [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_240M/clk_out1] [get_bd_pins radio/m_axi_aclk] [get_bd_pins rst_ps8_240M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/saxihp2_fpd_aclk]
  connect_bd_net -net lmk_reset_low_dout [get_bd_ports lmk_reset] [get_bd_pins lmk_reset_low/dout]
  connect_bd_net -net radio_irq [get_bd_pins axi_intc/intr] [get_bd_pins radio/irq]
  connect_bd_net -net rst_ps8_260M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins radio/m_axi_aresetn] [get_bd_pins rst_ps8_240M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_96M_peripheral_aresetn [get_bd_pins axi_intc/s_axi_aresetn] [get_bd_pins radio/s_axi_aresetn] [get_bd_pins rst_ps8_100M/peripheral_aresetn] [get_bd_pins s_axi_interconnect/ARESETN] [get_bd_pins s_axi_interconnect/M00_ARESETN] [get_bd_pins s_axi_interconnect/M01_ARESETN] [get_bd_pins s_axi_interconnect/S00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_pl_clk0 [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins radio/s_axi_aclk] [get_bd_pins rst_ps8_100M/slowest_sync_clk] [get_bd_pins s_axi_interconnect/ACLK] [get_bd_pins s_axi_interconnect/M00_ACLK] [get_bd_pins s_axi_interconnect/M01_ACLK] [get_bd_pins s_axi_interconnect/S00_ACLK] [get_bd_pins zynq_ultra_ps_e/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_pl_resetn0 [get_bd_pins radio/ext_reset] [get_bd_pins rst_ps8_100M/ext_reset_in] [get_bd_pins rst_ps8_240M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x80070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_00/DataInspector/axi_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x800A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_20/DataInspector/axi_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x80060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0x80080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_00/DataInspector/data_inspector_module/inspector_s_axi/reg0] -force
  assign_bd_address -offset 0x800B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_20/DataInspector/data_inspector_module/inspector_s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x800C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_20/decimator/xsg_bwselector_s_axi/reg0] -force
  assign_bd_address -offset 0x80050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_00/ofdm_receiver/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0x800D0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_20/ofdm_receiver/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0x800F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_00/ofdm_transmitter/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0x80100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_10/ofdm_transmitter/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0x80090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_00/spectrum_analyser/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0x800E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_20/spectrum_analyser/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_00/DataInspector/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_20/DataInspector/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_00/DataInspector/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_20/DataInspector/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM]
